...
bool GraphicsClass::Initialize(int screenWidth, int screenHeight, HWND hwnd)
{
	...
	result = m_Texture->Initialize(m_D3D->GetDevice(), L"../Project/data/UMP_lambert1_BaseColor.dds");
	if (!result)
	{
		return false;
	}
	...
	result = m_Model->Initialize(m_D3D->GetDevice(), "../Project/data/UMP_Test_New.obj", m_Texture);
	if(!result)
	{
